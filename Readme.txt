...
1. Cài đặt môi trường:
	...
	B3: Mở mã nguồn bằng chương trình Code (Sublime text, Atom,...) sửa lại thông tin kết nối database trong config/database.php và .env, trước đó phải tạo database mới trước.
